...
export const signin = async ({ email, password }) => {
  ...
  export const update = async ({ firstName, lastName, phone, deliveryAddress, additional, town, state, company, country  }) => {
    try {
      ...
      const response = await axios({
        ...
        data: {
          firstName, lastName, phone, deliveryAddress, additional, town, state, company, country
        },
      });
      if (response.statusText !== 'OK') {
        throw new Error(response.data.message);
  ...
  export const updatepass = async ({ opassword, npassword }) => {
    try {
      const { _id, token } = getUserInfo();
      const response = await axios({
        url: `${apiUrl}/api/users/pass/${_id}`,
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  export const getPaystackClientId = async () => {
    const response = await axios({
  ...
  export const canPay = async (orderId) => {
    try {
      const { token } = getUserInfo();
      const response = await axios({
        url: `${apiUrl}/api/orders/${orderId}/canpay`,
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
